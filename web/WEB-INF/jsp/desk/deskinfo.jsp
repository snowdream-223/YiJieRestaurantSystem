...
<div class="panel panel-info" id="deskInfo" style="display:none; ">
    ...
    <div class="panel-heading">
        ...
        <div class=" row" style="font-size: 16px;">
            ...
            <div class="col-lg-4">
                订单号：<span style="font-weight: bold;">${desk.deskCode }</span>&nbsp;&nbsp;&nbsp;状态：<span
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <button class="btn btn-default openDesk" data-toggle="modal"
                                ...
                                style="<c:if test="${desk.status!=1 }">display: none;</c:if>">添加订单
                        </button>
                    </div>
                    <div class="col-lg-3 setPeopleNum"
                         style="<c:if test="${desk.status==1 }">display: none;</c:if>">人数：
                    </div>
    ...
    <div class="panel-body deskInfoBody"
        ...
        <table class="table table-hover" id="finalCustormDishes">
                ...
                <tr class="columnDesk">
                    ...
                    <td>
                        <button class="btn btn-default updateBtn"
                                ...
                                dishNum="${dish.dishNum }" dishName="${dish.dishName }">更改
                        </button>
            ...
            <tfoot>
            <tr>
                <td class="totalMoneyTd" colspan="6" style="display:
                <c:if test="${empty deskDish or fn:length(deskDish) eq 0 }">none</c:if>
                        ;"><h3 id="total">
            ...
            <tr>
                <td colspan="6">
                    <ul class="pager">
                        ...
                        <li class="next"><a class="btn btn-warning " id="diancai"
...
<div id="selectDishes" style="display: none;">
    ...
    <div class="col-xs-7">
        <div class="panel panel-info" style="height:750px;">
            <div class="panel-heading">
                <span class="h3 text-left">订单号：${desk.deskCode }</span>
            </div>
            <div class="panel-body">
                    ...
                    <c:forEach items="${deskDish }" var="dish">
                        <tr class="columnDesk">
                            ...
                            <td>
                                ...
                                <button class="btn btn-default delBtn" dishName="${dish.dishName }">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
                        ...
                        <td colspan="6">
                            <ul class="pager">
                                ...
                                <li class="next sureDeskInfo"><a href="javascript:;"
                                                                 ...
                                                                 deskStatus=${desk.status } deskId="${desk.id }">
                                    提交 </a></li>
                            </ul>
                        </td>
                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary  sureDishBtn"
                        deskCode="${desk.deskCode }" data-dismiss="modal">确认
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                微信
                                                                         ...
                                                                         class="payType" name="payType" id="aliPay"
                                                                         value="2">
                                支付宝
                            </label> <label class="radio-inline"> <input type="radio"
                                                                         class="payType" name="payType" id="bankCard"
                                                                         value="3">
                                刷卡
                            </label> <label class="radio-inline"> <input type="radio"
                                                                         class="payType" name="payType" id="cash"
                                                                         value="4"> 现金
                            </label> <label class="radio-inline"> <input type="radio"
                                                                         class="payType" name="payType" id="debtor"
                                                                         value="5">
                                挂账
                            </label>
                            </div>
                                ...
                                <label for="" class="control-label">是否会员：</label> <label
                                    class="radio-inline"> <input type="radio" name="isVIP"
                                                                 id="VIP" value="1" class="isVIP"> 是
                                                                         ...
                                                                         class="isVIP" name="isVIP" id="notVIP"
                                                                         value="2" checked>
                                否
                            </label>
                            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pay" discount=""
                        payType="" deskId="${desk.id }" deskCode="${desk.deskCode }" peopleNum="${desk.peopleNum}">确认
                </button>
            </div>
        </div>
    </div>
