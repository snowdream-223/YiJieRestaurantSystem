        ...
        <c:forEach items="${pager.list }" var="dish" varStatus="statu">
            ...
            <td>
                ...
                <a href="javascript:;" style="text-decoration:none;"
                   class="dishBtn"
                   dishName="${dish.dishName }" drinkBillCode="${dish.drinkBillCode }" dishPrice="${dish.price }"><img
                        style="width: 121px;height: 79px;"
                        src="${pageContext.request.contextPath}/assets/img/${dish.id}.jpg"
                        class="img-thumbnail">
                </a>
