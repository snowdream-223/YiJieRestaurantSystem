        ...
        <c:if test="${pager.pageCount!=1 and pager.pageCount!=0 }">
            <ul class="pager">
                <c:if test="${pager.pageIndex>1 }">
                    <li class="previous providerListPagerBtn"><a pageIndex="${pager.pageIndex-1}"
                                                                 serchProName="${pager.serchProName}" opr="${pager.opr}"
                                                                 href="javascript:;">
                        上一页 </a></li>
                </c:if>
                ...
                <c:if test="${pager.pageIndex<pager.pageCount }">
                    <li class="next providerListPagerBtn"><a pageIndex="${pager.pageIndex+1}"
                                                             serchProName="${pager.serchProName}" opr="${pager.opr}"
                                                             href="javascript:;">
                        下一页 </a></li>
                </c:if>
