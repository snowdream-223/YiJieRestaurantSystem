        ...
        <c:if test="${pager.pageCount!=1 and pager.pageCount!=0 }">
            <ul class="pager">
                <c:if test="${pager.pageIndex>1 }">
                    <li class="previous userListPagerBtn"><a pageIndex="${pager.pageIndex-1}"
                                                             userSerchName="${pager.userSerchName}" opr="${pager.opr}"
                                                             href="javascript:;">
                        上一页 </a></li>
                </c:if>
                ...
                <c:if test="${pager.pageIndex<pager.pageCount }">
                    <li class="next userListPagerBtn"><a pageIndex="${pager.pageIndex+1}"
                                                         userSerchName="${pager.userSerchName}" opr="${pager.opr}"
                                                         href="javascript:;">
                        下一页 </a></li>
                </c:if>
