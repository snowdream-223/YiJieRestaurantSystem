...
<ul class="nav nav-tabs ">
    ...
    <li role="presentation"
        ...
        <ul class="dropdown-menu">
            <li class="<c:if test="${param.billType=='year'}">active</c:if>"><a
                    href="${pageContext.request.contextPath }/yearBill.html?billType=year&show=bill">年</a></li>
            <li class="<c:if test="${param.billType=='month'}">active</c:if>"><a
                    href="${pageContext.request.contextPath }/monthBill.html?billType=month&show=bill">月</a></li>
            <li class="<c:if test="${param.billType=='date'}">active</c:if>"><a
                    href="${pageContext.request.contextPath }/dateBill.html?billType=date&show=bill&opr=date">日</a>
            </li>
        </ul>
    </li>
    <li style="height:30px;">
        <form class="navbar-form " style="margin-top:0px;" method="post"
              action="${pageContext.request.contextPath }/dateBill.html?show=bill&opr=serch">
