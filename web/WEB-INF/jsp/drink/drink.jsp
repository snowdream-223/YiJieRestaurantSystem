        ...
        <div class="tab-pane fade" id="xiaoshou">
            <div class="col-lg-12 col-md-12 ">
                ...
                <div class="table-responsive ">
                    ...
                    <span
                            class="input-group-addon ">供应商</span><select type="text" id="sellProviderId"
                                                                            name="sellProviderId"
                        ...
                        <div class="col-lg-3">
                            <div class="input-group">
                     <span
                             class="input-group-addon">商品名称</span><input type="text" id="sellProductName"
                ...
                <div class="table-responsive ">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="input-group">
                    <span
                            class="input-group-addon ">供应商</span><select type="text" id="suplusProviderId"
                                                                            name="suplusProviderId"
                                                                            class="form-control providerSlecteDiv">
                        ...
                        <div class="col-lg-3">
                            <div class="input-group">
                     <span
                             class="input-group-addon">商品名称</span><input type="text" id="suplusProductName"
                                                                             name="suplusProductName"
                                                                             class="form-control"/>
                            </div>
                        </div>
                        <div class="col-lg-3">
