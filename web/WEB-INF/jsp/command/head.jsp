        ...
        <div class="adjust-nav">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> <img
                        style="max-width: 80px;max-height: 80px;position: absolute;
top: 10%"
			...
			<span class="logout-spn">
			 <a href="javascript:;" style="color:#fff;">操作员:${user.userName }</a>
				<p class="text-right"><a href="${pageContext.request.contextPath}/logout.html"
                                         style="color:white;font-size: 14px;">注销</a></p>
			</span>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/tongji.html?show=tongji"
                        <c:if test="${param.show=='tongji' }">class="active-link"</c:if>><i
                        class="fa fa-qrcode "></i>库存统计</a></li>
