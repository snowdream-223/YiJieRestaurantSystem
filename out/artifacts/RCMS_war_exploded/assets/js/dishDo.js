$(function () {
    ...
    $("#addDish").click(function () {
        ...
        if (dishdesc == "" || dishdesc == null) {
            $("#dishdesceError").css("color", "red");
            $("#dishdesceError").text("请输入菜品描述")
        } else {
            $("#dishdesceError").css("color", "green");
            $("#dishdesceError").text("√");
            dishNameFlag = true;
        }
        // 插入菜品名描述
        ...
        if (submitFlag) {//验证成功，执行ajax请求
            $.ajaxFileUpload({
                ...
                data: {"dishdesc":dishdesc,"dishName": dishName, "price": price, "type": type,"drinkBillCode":drinkBillCode},
