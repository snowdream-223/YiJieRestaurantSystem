...
<%--            插入菜品备注--%>
            <div class="input-group">
                <span class="input-group-addon">描述：</span> <input type="text" name="dishdesc"
                                                                    id="dishdesc" class="form-control"
                                                                    placeholder="菜品描述"/>
                <span id="dishdescError" class="input-group-addon" style="color: red;">${dishdescError}</span>
            </div>
            <%--            插入菜品备注--%>
            <br>
